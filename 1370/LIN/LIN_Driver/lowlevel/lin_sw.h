...
/**
* @struct lin_signal_struct
* signal structure
*/
typedef struct  {
  lin_signal_type     sig_type;           /**< Type of signal */
  l_u8                sig_size_bit;       /**< Signal size in terms of bits.*/
  l_u8                *sig_data;          /**< pointer to signal data*/
} lin_signal_struct;
...
typedef struct  {
  ...
  l_u8                num_of_sig;       /**< Number of signal that associate with the Frame*/
...
*/
typedef struct  {
  l_signal_handle     sig_id;             /**< Signal name*/
  l_u8                offset;             /**< Signal offset in frame*/
} lin_frm2sig;
...
/* Protocol */
  ...
  l_u8                          num_of_signals;                 /**< Number of signal except diagnostic signals */
  l_u8                          signal_start;                   /**< Start index of signal list */
  const lin_signal_struct       *signal_tbl;                    /**< Signal list except diagnostic signals */
  l_u8                          *signal_flg;                    /**< Signal flag */
...
/*FUNCTION*--------------------------------------------------------------*//**
* @fn l_u8 lin_lld_get_status (l_ifc_handle iii)
* @brief This function gets current status of an interface
*
* @param iii <B>[IN]</B> lin interface handle
*
* @return #l_u8
...
*//*END*----------------------------------------------------------------------*/
l_u8 lin_lld_get_status(l_ifc_handle iii);
...
/*****************************************************************/
/*****    Common variables    *****/
extern l_bool                   lin_flag_frame_handle_tbl[LIN_NUM_OF_FRMS];
extern l_bool                   lin_flag_signal_handle_tbl[LIN_NUM_OF_SIGS];
extern const lin_frame_struct   lin_frame_tbl[LIN_NUM_OF_FRMS];
extern const lin_signal_struct  lin_signal_tbl[LIN_NUM_OF_SIGS];
extern l_bool                   lin_signal_flag_tbl[LIN_NUM_OF_SIGS];
...
extern l_bool        l_bool_rd (l_signal_handle sss);
extern l_u8          l_u8_rd (l_signal_handle sss);
extern l_u16         l_u16_rd (l_signal_handle sss);
extern void          l_bool_wr (l_signal_handle sss, l_bool v);
extern void          l_u8_wr (l_signal_handle sss, l_u8 v );
extern void          l_u8_index_wr (l_u8 index);
extern void          l_u16_wr (l_signal_handle sss, l_u16 v);
extern void          l_bytes_rd (l_signal_handle sss, l_u8 start, l_u8 count, l_u8* const data);
extern void          l_bytes_wr (l_signal_handle sss, l_u8 start, l_u8 count, l_u8* const data);
extern l_bool        l_flg_tst (l_flag_handle fff);
extern void          l_flg_clr (l_flag_handle fff);
/*********************************/
...
#if LIN_MODE == _SLAVE_MODE_
extern void          lin_update_frame_flag(l_signal_handle sss,l_u8 frm_index);
#if (_TL_FRAME_SUPPORT_ == _TL_MULTI_FRAME_)
/* INITIALIZATION */
...
extern void          lin_update_frame_flag(lin_configuration *conf_ptr, l_signal_handle sss);
extern l_ifc_handle  lin_find_associate_ifc (l_signal_handle sss);
