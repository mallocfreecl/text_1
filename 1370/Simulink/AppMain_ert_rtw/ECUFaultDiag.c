...
#define IN_DefaultStatus_mpgg          ((uint8_T)1U)
#define IN_High_fhmx                   ((uint8_T)2U)
#define IN_Low_lcjb                    ((uint8_T)3U)
#define IN_NO_ACTIVE_CHILD_ja4g        ((uint8_T)0U)
#define IN_Normal_deso                 ((uint8_T)4U)

/* Forward declaration for local functions */
static void UpdateStateCnt_hvit(int16_T lowTHR, int16_T highTHR, int16_T
...
void AmbTemperatureDiag_Init(int8_T *rty_AmbTStatus, DW_AmbTemperatureDiag_T
  *localDW)
{
  /* SystemInitialize for Chart: 'TemperaturState' (':3117') */
  TemperaturState_Init(rty_AmbTStatus, &localDW->sf_TemperaturState);
}
  ...
  DW_AmbTemperatureDiag_T *localDW)
{
  ...
  TemperaturState(rtu_AmbTemperature, rty_AmbTStatus, 100, 145, 143, 2000, -40,
                  -38, &localDW->sf_TemperaturState);
}
  ...
  rtu_Voltage, DW_VoltageDiag_T *localDW)
{
  ...
  else
  {
    /* Transition: (':6:46') */
    /* (':6:48:1') */
    if ((int32_T)rtu_Voltage > (int32_T)highTHR)
    {
      /* Transition: (':6:48') */
      /* (':6:48:1') */
      localDW->LowCnt = 0U;
...
void VoltageDiag_Init(int8_T *rty_VoltageStatus, DW_VoltageDiag_T *localDW)
{
  ...
  localDW->is_c2_lib1 = IN_NO_ACTIVE_CHILD_ja4g;
  localDW->LowCnt = 0U;
  localDW->HighCnt = 0U;
  localDW->NormalCnt = 0U;
                 ...
                 DW_VoltageDiag_T *localDW)
{
  ...
  if ((uint32_T)localDW->is_active_c2_lib1 == 0U)
  {
    ...
    /* Transition: (':6:17') */
    localDW->is_c2_lib1 = IN_DefaultStatus_mpgg;
  ...
  else
  {
    switch (localDW->is_c2_lib1)
    {
     case IN_DefaultStatus_mpgg:
      ...
      if (localDW->IsInited)
      {
        ...
        switch ((int32_T)localDW->DefaultStatus)
        {
         case 0:
          /* Transition: (':6:66') */
          localDW->is_c2_lib1 = IN_Normal_deso;
         ...
         case -1:
          /* Transition: (':6:68') */
          /* Transition: (':6:69') */
          localDW->is_c2_lib1 = IN_Low_lcjb;
         ...
         default:
          ...
          /* Transition: (':6:74') */
          /* Transition: (':6:73') */
          localDW->is_c2_lib1 = IN_High_fhmx;
     ...
     case IN_High_fhmx:
      /* During 'High': (':6:23') */
      if (((int32_T)rtu_Voltage < 80) && ((int32_T)localDW->LowCnt >= 50))
      {
        /* Transition: (':6:30') */
        /* Transition: (':6:31') */
        localDW->is_c2_lib1 = IN_Low_lcjb;
      ...
      {
        UpdateStateCnt_hvit(80, 169, rtu_Voltage, localDW);
      }
      break;

     case IN_Low_lcjb:
      /* During 'Low': (':6:20') */
      if (((int32_T)rtu_Voltage > 180) && ((int32_T)localDW->HighCnt >= 50))
      {
        /* Transition: (':6:27') */
        /* Transition: (':6:28') */
        localDW->is_c2_lib1 = IN_High_fhmx;
      ...
      else if (((int32_T)rtu_Voltage > 90) && ((int32_T)localDW->NormalCnt >= 50))
      {
        /* Transition: (':6:21') */
        localDW->is_c2_lib1 = IN_Normal_deso;
      ...
      {
        UpdateStateCnt_hvit(91, 180, rtu_Voltage, localDW);
      }
      break;
     ...
     default:
      ...
      else if (((int32_T)rtu_Voltage > 180) && ((int32_T)localDW->HighCnt >= 50))
      {
        /* Transition: (':6:24') */
        localDW->is_c2_lib1 = IN_High_fhmx;
      ...
      {
        UpdateStateCnt_hvit(80, 180, rtu_Voltage, localDW);
      }
      break;
    }
  }
