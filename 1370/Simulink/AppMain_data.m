...
CtrlConst.PwmIn.BusTimeOutCntTHR = uint16(1000); %Bus idle State time out time,unit:ms
...
CtrlConst.SpeedCtrl.PwmIn.Freq.ValidJudgeFilterTime = uint16(100e-3/TaskTimeBase.SpeedCtrl); %100e-3s

CtrlConst.SpeedCtrl.PwmIn.Duty = struct;
CtrlConst.SpeedCtrl.PwmIn.Duty.Default = uint16(0); % 100*0.1%=10%
...
CtrlConst.SpeedCtrl.PwmIn.TargetSpeed.Min = int16(1160);%rpm
CtrlConst.SpeedCtrl.PwmIn.TargetSpeed.Max = int16(5800);%rpm
...
CtrlConst.FaultDiag.Voltage.FilterTime = uint16(0.5/TaskTimeBase.FaultDiag);
...
CtrlConst.FaultDiag.AmbTemperature.PreOverFilterTime = uint16(1/TaskTimeBase.FaultDiag);
...
CtrlConst.FaultDiag.AmbTemperature.THR.PreOverEntry = int16(140); % degree centigrade
CtrlConst.FaultDiag.AmbTemperature.THR.PreOverExit = int16(138); % degree centigrade
CtrlConst.FaultDiag.AmbTemperature.THR.OverEntry = int16(145); % degree centigrade
CtrlConst.FaultDiag.AmbTemperature.THR.OverExit = int16(143); % degree centigrade
...
CtrlConst.FeedBack.LowTime.AmbT = uint16(1/TaskTimeBase.FeedBack);
...
CtrlConst.FeedBack.HighTime.AmbT = uint16(2/TaskTimeBase.FeedBack);
